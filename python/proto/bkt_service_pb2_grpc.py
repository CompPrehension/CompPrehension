...
import bkt_service_pb2 as bkt__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in bkt_service_pb2_grpc.py depends on'
...
def add_BktServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'bkt.BktService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('bkt.BktService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class BktService(object):
    """Missing associated documentation comment in .proto file."""
