/*
 * Patched copy of liquibase.ext.hibernate.snapshot.ColumnSnapshotGenerator from liquibase-hibernate7 5.0.4
 * (Apache License 2.0). The original class is excluded from the shaded jar, so this copy replaces it.
 ...
 * Re-apply when liquibase-hibernate7 is upgraded.
 */
