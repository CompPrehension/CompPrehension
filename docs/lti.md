...
Старые адреса `/lti/1_3/exercise`, `/lti/1_3/exercise-settings`, `/lti/1_3/configure-course` работают
по-прежнему — на них указывают ранее настроенные инструменты и активности.
