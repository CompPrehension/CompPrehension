...
import org.vstu.compprehension.models.businesslogic.backends.facts.JenaFact;
import org.vstu.compprehension.models.businesslogic.backends.facts.JenaFactList;
import org.vstu.compprehension.util.MakeNamedSkolem;
...
//        PrintUtil.registerPrefix("skos", "http://www.w3.org/2004/02/skos/core"); //?
        ...
        model = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM);  // createDefaultModel();
...
//            long startStepTime = System.nanoTime();
            ...
            model = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM);  // use empty to add to
            model.add( inf );
        }
        if (retainNewFactsOnly) {
