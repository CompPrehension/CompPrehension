...
public final class TestData {
    ...
    public static final class EducationResources {
        private EducationResources() {
        }

        public static final long ID = -1L;
        public static final String URL = "https://lms.test.local";
    }
    ...
    public static final class Courses {
        ...
        public static final long MAIN_ID = -1L;
        public static final String MAIN_EXTERNAL_ID = "ext-course-1";
        public static final long OTHER_ID = -2L;
        public static final String OTHER_EXTERNAL_ID = "ext-course-2";
    }
    ...
    public static final class Exercises {
        ...
        public static final long GLOBAL_POOL_ID = -1L;
        public static final long MAIN_COURSE_ID = -2L;
        public static final long INHERITED_ID = -3L;
    ...
    public static final class Users {
        ...
        public static final long WITHOUT_ROLES_ID = -8L;
        public static final long EDUCATION_RESOURCE_ADMIN_ID = -9L;
    }

    public static final class ExpressionBank {
        ...
        public static final List<BankQuestion> ALL = List.of(
                MEMBER_ACCESS_PLUS, MODULO_PLUS, MUL_PLUS_MINUS, ASSIGN_UNARY_MINUS_PLUS, PARENTHESES_AND_UNARY_MINUS);

        public static BankQuestion byMetadataId(int metadataId) {
            return ALL.stream()
