...
const resources = {
    ...
    RU: {
        translation: {
            ...
            tour_exprs_intro: "Добро пожаловать в упражнение CompPrehension! Новичкам рекомендуем познакомиться с элементами управления",
            ...
            tour_exprs_operator: "Это один из операторов выражения, и он подчёркнут. Операторы нужно нажимать в процессе решения задачи.",
            ...
            tour_exprs_tracevalue: "Некоторые операторы ведут себя по-разному в зависимости от значения его операндов. Значения таких операндов отображаются здесь. «true» — истина (ДА), «false» — ложь (НЕТ).",
