...
import org.vstu.compprehension.helpers.FactsGraph;
...
import static org.vstu.compprehension.DomainVocabulary.retainLeafOntClasses;
import static org.vstu.compprehension.DomainVocabulary.testSubClassOfTransitive;
import static org.vstu.compprehension.helpers.FactsGraph.factsListDeepCopy;
@Log4j2
...
//        Set<? extends OntResource> instSet = Erroneous.listInstances().toSet();
    ...
    private static OntModel modelToOntModel(Model model) {
        OntModel ontModel = ModelFactory.createOntologyModel(OntModelSpec.OWL_MEM);        ontModel.add(model);
        return ontModel;
    }
