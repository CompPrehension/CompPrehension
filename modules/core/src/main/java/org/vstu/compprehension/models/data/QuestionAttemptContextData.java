 ...
 * <p>
 * Один тип на четыре вопроса сервиса — язык автора, этапы упражнения, идентификатор
 * попытки, режим вспомогательных вопросов, — потому что все они отвечаются одной
 * строкой. Раньше каждый из них поднимал попытку отдельно, и вместе с ней все её
