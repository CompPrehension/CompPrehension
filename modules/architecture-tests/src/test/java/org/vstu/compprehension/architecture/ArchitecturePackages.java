...
public final class ArchitecturePackages {
    ...
    /** Мапперы между объектами бизнес-логики и моделями данных. */
    public static final String SERVICE_MAPPERS = ROOT + ".services.mappers..";

    /** Все места, где живёт маппинг. */
    public static final String[] MAPPERS = {MAPPER_API, DATA_MAPPERS, FRONTEND_MAPPERS, SERVICE_MAPPERS};
